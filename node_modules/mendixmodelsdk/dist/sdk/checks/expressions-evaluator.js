...
function evaluateExpression(expr, structure, queryResolver, context) {
    ...
    function _eval(evaluatable, source, context) {
        var polyMap = {
            ...
            "MxListLiteralExpression": function (expr) {
                var listLiteralExpr = expr;
                var evalItems = listLiteralExpr.items.map(function (item) { return _eval(item, source, context); });
            ...
            "MxQualifiedEnumLiteralExpression": function (expr) {
                return evalQualifiedEnumLiteral(expr);
            },
            "MxSizeLiteralExpression": function (expr) {
                var sizeLiteralExpr = expr;
            ...
            "MxStructureLiteralExpression": function (expr) {
                return evalStructureLiteral(expr, source, context);
            },
            ...
            "MxTypeStructureLiteralExpression": function (expr) {
                var typeStructureLiteralExpr = expr;
    ...
    function evalMethodCall(expr, source, context) {
        ...
        var query = queryResolver(expr.referredMethod, source.structureTypeName);
        if (query) {
