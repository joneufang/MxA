...
function verbose(source) {
    ...
    if (source.structureTypeName) {
        var name_1 = source.qualifiedName || source.name;
        return "<" + source.structureTypeName + ">" + (name_1 ? "'" + name_1 + "'" : "");
    }
    if (mobx_1.isObservableArray(source) || lodash_1.isArray(source)) {
        return source.length > 0 ? (mobx_1.isObservableArray(source) ? "@" : "") + "[ " + source.slice().map(verbose).join(", ") + " ]" : "[]";
    }
...
//# sourceMappingURL=expressions-debug-util.js.map