...
var name_util_1 = require("./name-util");
...
function firstContainerOfTypes(source, args) {
    var typeLiterals = isNotList(args) ? [] : args.filter(function (typeLiteral) { return typeLiteral instanceof StructureTypeLiteral; });
    ...
    while (!expressions_evaluator_1.isNothing(currentStructure) && !(typeLiterals.some(function (typeLiteral) { return currentStructure instanceof typeLiteral.clazz; }))) {
...
function parts(source) {
    ...
    var structures = [];
    something.traverse(function (structure) {
...
var StructureTypeLiteral = /** @class */ (function () {
    function StructureTypeLiteral(clazz /* TODO  sharpen type */) {
        this.clazz = clazz; /* TODO  sharpen type */
    }
    return StructureTypeLiteral;
}());
