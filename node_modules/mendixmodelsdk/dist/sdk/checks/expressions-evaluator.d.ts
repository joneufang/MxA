...
export declare function evaluateExpression(expr: Evaluatable, structure: IStructure | null | undefined, queryResolver: IQueryResolver, context?: Context | null): any;
/**
 * Checks whether the argument is "nothing", i.e. either undefined or null.
 */
export declare function isNothing(arg: any): arg is undefined | null;
