...
export declare namespace expressions {
    ...
    abstract class Expression extends internal.Element {
        ...
        readonly containerAsExpressionValue: pluginwidgets.ExpressionValue;
    ...
    class BinaryExpression extends Expression {
         ...
         *  7.9.0 and higher
         */
        static createInExpressionValueUnderValueModel(container: pluginwidgets.ExpressionValue): BinaryExpression;
        /**
         * Creates and returns a new BinaryExpression instance in the SDK and on the server.
    ...
    class BooleanLiteral extends LiteralExpression {
         ...
         *  7.9.0 and higher
         */
        static createInExpressionValueUnderValueModel(container: pluginwidgets.ExpressionValue): BooleanLiteral;
        /**
         * Creates and returns a new BooleanLiteral instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class ConstantRefExpression extends Expression {
         ...
         *  7.9.0 and higher
         */
        static createInExpressionValueUnderValueModel(container: pluginwidgets.ExpressionValue): ConstantRefExpression;
        /**
         * Creates and returns a new ConstantRefExpression instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class EmptyLiteral extends LiteralExpression {
         ...
         *  7.9.0 and higher
         */
        static createInExpressionValueUnderValueModel(container: pluginwidgets.ExpressionValue): EmptyLiteral;
        /**
         * Creates and returns a new EmptyLiteral instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class EnumerationValueRefExpression extends Expression {
         ...
         *  7.9.0 and higher
         */
        static createInExpressionValueUnderValueModel(container: pluginwidgets.ExpressionValue): EnumerationValueRefExpression;
        /**
         * Creates and returns a new EnumerationValueRefExpression instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class FloatLiteral extends LiteralExpression {
         ...
         *  7.9.0 and higher
         */
        static createInExpressionValueUnderValueModel(container: pluginwidgets.ExpressionValue): FloatLiteral;
        /**
         * Creates and returns a new FloatLiteral instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class FunctionCallExpression extends Expression {
         ...
         *  7.9.0 and higher
         */
        static createInExpressionValueUnderValueModel(container: pluginwidgets.ExpressionValue): FunctionCallExpression;
        /**
         * Creates and returns a new FunctionCallExpression instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class IfExpression extends Expression {
         ...
         *  7.9.0 and higher
         */
        static createInExpressionValueUnderValueModel(container: pluginwidgets.ExpressionValue): IfExpression;
        /**
         * Creates and returns a new IfExpression instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class IntegerLiteral extends LiteralExpression {
         ...
         *  7.9.0 and higher
         */
        static createInExpressionValueUnderValueModel(container: pluginwidgets.ExpressionValue): IntegerLiteral;
        /**
         * Creates and returns a new IntegerLiteral instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class NoExpression extends Expression {
         ...
         *  7.9.0 and higher
         */
        static createInExpressionValueUnderValueModel(container: pluginwidgets.ExpressionValue): NoExpression;
        /**
         * Creates and returns a new NoExpression instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class ParenthesisExpression extends Expression {
         ...
         *  7.9.0 and higher
         */
        static createInExpressionValueUnderValueModel(container: pluginwidgets.ExpressionValue): ParenthesisExpression;
        /**
         * Creates and returns a new ParenthesisExpression instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class StringLiteral extends LiteralExpression {
         ...
         *  7.9.0 and higher
         */
        static createInExpressionValueUnderValueModel(container: pluginwidgets.ExpressionValue): StringLiteral;
        /**
         * Creates and returns a new StringLiteral instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class UnaryExpression extends Expression {
         ...
         *  7.9.0 and higher
         */
        static createInExpressionValueUnderValueModel(container: pluginwidgets.ExpressionValue): UnaryExpression;
        /**
         * Creates and returns a new UnaryExpression instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class UnparsableExpression extends Expression {
         ...
         *  7.9.0 and higher
         */
        static createInExpressionValueUnderValueModel(container: pluginwidgets.ExpressionValue): UnparsableExpression;
        /**
         * Creates and returns a new UnparsableExpression instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class VariableRefExpression extends Expression {
         ...
         *  7.9.0 and higher
         */
        static createInExpressionValueUnderValueModel(container: pluginwidgets.ExpressionValue): VariableRefExpression;
        /**
         * Creates and returns a new VariableRefExpression instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
