...
var reports;
(function (reports) {
    var AggregateFunctionEnum = /** @class */ (function (_super) {
    ...
    var DateRangeFieldEnum = /** @class */ (function (_super) {
     ...
     */
    var ReportWidget = /** @class */ (function (_super) {
        __extends(ReportWidget, _super);
        function ReportWidget(model, structureTypeName, id, isPartial, unit, container) {
        ...
        Object.defineProperty(ReportWidget.prototype, "containerAsBuildingBlock", {
        ...
        Object.defineProperty(ReportWidget.prototype, "containerAsMasterDetailRegion", {
    ...
    var BasicReport = /** @class */ (function (_super) {
        ...
        function BasicReport(model, structureTypeName, id, isPartial, unit, container) {
            var _this = _super.call(this, model, structureTypeName, id, isPartial, unit, container) || this;
            /** @internal */
        ...
        Object.defineProperty(BasicReport.prototype, "containerAsBuildingBlock", {
            get: function () { return _super.prototype.getContainerAs.call(this, pages_1.pages.BuildingBlock); },
            enumerable: true,
            configurable: true
        });
        ...
        Object.defineProperty(BasicReport.prototype, "containerAsMasterDetailRegion", {
            get: function () { return _super.prototype.getContainerAs.call(this, pages_1.pages.MasterDetailRegion); },
            enumerable: true,
            configurable: true
        });
         ...
         *  7.7.0 and higher
         */
        BasicReport.createInBuildingBlockUnderWidget = function (container) {
            internal.createInVersionCheck(container.model, BasicReport.structureTypeName, { start: "7.7.0" });
        ...
        BasicReport.createInDataViewUnderFooterWidget = function (container) {
            internal.createInVersionCheck(container.model, BasicReport.structureTypeName, { start: "6.7.0" });
         ...
         *  7.1.0 and higher
         */
        BasicReport.createInMasterDetailRegionUnderWidget = function (container) {
            internal.createInVersionCheck(container.model, BasicReport.structureTypeName, { start: "7.1.0" });
            return internal.instancehelpers.createElement(container, BasicReport, "widget", false);
        };
        /**
         * Creates and returns a new BasicReport instance in the SDK and on the server.
    ...
    var BasicReportAggregate = /** @class */ (function (_super) {
        __extends(BasicReportAggregate, _super);
        function BasicReportAggregate(model, structureTypeName, id, isPartial, unit, container) {
            var _this = _super.call(this, model, structureTypeName, id, isPartial, unit, container) || this;
            /** @internal */
    ...
    var BasicReportColumn = /** @class */ (function (_super) {
        __extends(BasicReportColumn, _super);
        function BasicReportColumn(model, structureTypeName, id, isPartial, unit, container) {
            var _this = _super.call(this, model, structureTypeName, id, isPartial, unit, container) || this;
            /** @internal */
     ...
     */
    var ReportButton = /** @class */ (function (_super) {
        __extends(ReportButton, _super);
        function ReportButton(model, structureTypeName, id, isPartial, unit, container) {
            var _this = _super.call(this, model, structureTypeName, id, isPartial, unit, container) || this;
            /** @internal */
        ...
        Object.defineProperty(ReportButton.prototype, "containerAsBuildingBlock", {
            get: function () { return _super.prototype.getContainerAs.call(this, pages_1.pages.BuildingBlock); },
            enumerable: true,
            configurable: true
        });
        ...
        Object.defineProperty(ReportButton.prototype, "containerAsMasterDetailRegion", {
            get: function () { return _super.prototype.getContainerAs.call(this, pages_1.pages.MasterDetailRegion); },
            enumerable: true,
            configurable: true
        });
         ...
         *  7.7.0 and higher
         */
        ReportButton.createInBuildingBlockUnderWidget = function (container) {
            internal.createInVersionCheck(container.model, ReportButton.structureTypeName, { start: "7.7.0" });
        ...
        ReportButton.createInDataViewUnderFooterWidget = function (container) {
            internal.createInVersionCheck(container.model, ReportButton.structureTypeName, { start: "6.7.0" });
         ...
         *  7.1.0 and higher
         */
        ReportButton.createInMasterDetailRegionUnderWidget = function (container) {
            internal.createInVersionCheck(container.model, ReportButton.structureTypeName, { start: "7.1.0" });
            return internal.instancehelpers.createElement(container, ReportButton, "widget", false);
        };
        /**
         * Creates and returns a new ReportButton instance in the SDK and on the server.
     ...
     */
    var ReportChart = /** @class */ (function (_super) {
        __extends(ReportChart, _super);
        function ReportChart(model, structureTypeName, id, isPartial, unit, container) {
            var _this = _super.call(this, model, structureTypeName, id, isPartial, unit, container) || this;
            /** @internal */
        ...
        Object.defineProperty(ReportChart.prototype, "containerAsBuildingBlock", {
            get: function () { return _super.prototype.getContainerAs.call(this, pages_1.pages.BuildingBlock); },
            enumerable: true,
            configurable: true
        });
        ...
        Object.defineProperty(ReportChart.prototype, "containerAsMasterDetailRegion", {
            get: function () { return _super.prototype.getContainerAs.call(this, pages_1.pages.MasterDetailRegion); },
            enumerable: true,
            configurable: true
        });
         ...
         *  7.7.0 and higher
         */
        ReportChart.createInBuildingBlockUnderWidget = function (container) {
            internal.createInVersionCheck(container.model, ReportChart.structureTypeName, { start: "7.7.0" });
        ...
        ReportChart.createInDataViewUnderFooterWidget = function (container) {
            internal.createInVersionCheck(container.model, ReportChart.structureTypeName, { start: "6.7.0" });
         ...
         *  7.1.0 and higher
         */
        ReportChart.createInMasterDetailRegionUnderWidget = function (container) {
            internal.createInVersionCheck(container.model, ReportChart.structureTypeName, { start: "7.1.0" });
            return internal.instancehelpers.createElement(container, ReportChart, "widget", false);
        };
        /**
         * Creates and returns a new ReportChart instance in the SDK and on the server.
    ...
    var ReportChartSeries = /** @class */ (function (_super) {
        __extends(ReportChartSeries, _super);
        function ReportChartSeries(model, structureTypeName, id, isPartial, unit, container) {
            var _this = _super.call(this, model, structureTypeName, id, isPartial, unit, container) || this;
            /** @internal */
     ...
     */
    var ReportDateRangeField = /** @class */ (function (_super) {
        __extends(ReportDateRangeField, _super);
        function ReportDateRangeField(model, structureTypeName, id, isPartial, unit, container) {
            var _this = _super.call(this, model, structureTypeName, id, isPartial, unit, container) || this;
            /** @internal */
    ...
    var ReportParameter = /** @class */ (function (_super) {
        __extends(ReportParameter, _super);
        function ReportParameter(model, structureTypeName, id, isPartial, unit, container) {
            var _this = _super.call(this, model, structureTypeName, id, isPartial, unit, container) || this;
            /** @internal */
        ...
        Object.defineProperty(ReportParameter.prototype, "containerAsBuildingBlock", {
            get: function () { return _super.prototype.getContainerAs.call(this, pages_1.pages.BuildingBlock); },
            enumerable: true,
            configurable: true
        });
        ...
        Object.defineProperty(ReportParameter.prototype, "containerAsMasterDetailRegion", {
            get: function () { return _super.prototype.getContainerAs.call(this, pages_1.pages.MasterDetailRegion); },
            enumerable: true,
            configurable: true
        });
     ...
     */
    var ReportDateRangeSelector = /** @class */ (function (_super) {
        __extends(ReportDateRangeSelector, _super);
        function ReportDateRangeSelector(model, structureTypeName, id, isPartial, unit, container) {
            var _this = _super.call(this, model, structureTypeName, id, isPartial, unit, container) || this;
            /** @internal */
        ...
        Object.defineProperty(ReportDateRangeSelector.prototype, "containerAsBuildingBlock", {
            get: function () { return _super.prototype.getContainerAs.call(this, pages_1.pages.BuildingBlock); },
            enumerable: true,
            configurable: true
        });
        ...
        Object.defineProperty(ReportDateRangeSelector.prototype, "containerAsMasterDetailRegion", {
            get: function () { return _super.prototype.getContainerAs.call(this, pages_1.pages.MasterDetailRegion); },
            enumerable: true,
            configurable: true
        });
         ...
         *  7.7.0 and higher
         */
        ReportDateRangeSelector.createInBuildingBlockUnderWidget = function (container) {
            internal.createInVersionCheck(container.model, ReportDateRangeSelector.structureTypeName, { start: "7.7.0" });
        ...
        ReportDateRangeSelector.createInDataViewUnderFooterWidget = function (container) {
            internal.createInVersionCheck(container.model, ReportDateRangeSelector.structureTypeName, { start: "6.7.0" });
         ...
         *  7.1.0 and higher
         */
        ReportDateRangeSelector.createInMasterDetailRegionUnderWidget = function (container) {
            internal.createInVersionCheck(container.model, ReportDateRangeSelector.structureTypeName, { start: "7.1.0" });
            return internal.instancehelpers.createElement(container, ReportDateRangeSelector, "widget", false);
        };
        /**
         * Creates and returns a new ReportDateRangeSelector instance in the SDK and on the server.
     ...
     */
    var ReportDropDown = /** @class */ (function (_super) {
        __extends(ReportDropDown, _super);
        function ReportDropDown(model, structureTypeName, id, isPartial, unit, container) {
            var _this = _super.call(this, model, structureTypeName, id, isPartial, unit, container) || this;
            /** @internal */
        ...
        Object.defineProperty(ReportDropDown.prototype, "containerAsBuildingBlock", {
            get: function () { return _super.prototype.getContainerAs.call(this, pages_1.pages.BuildingBlock); },
            enumerable: true,
            configurable: true
        });
        ...
        Object.defineProperty(ReportDropDown.prototype, "containerAsMasterDetailRegion", {
            get: function () { return _super.prototype.getContainerAs.call(this, pages_1.pages.MasterDetailRegion); },
            enumerable: true,
            configurable: true
        });
         ...
         *  7.7.0 and higher
         */
        ReportDropDown.createInBuildingBlockUnderWidget = function (container) {
            internal.createInVersionCheck(container.model, ReportDropDown.structureTypeName, { start: "7.7.0" });
        ...
        ReportDropDown.createInDataViewUnderFooterWidget = function (container) {
            internal.createInVersionCheck(container.model, ReportDropDown.structureTypeName, { start: "6.7.0" });
         ...
         *  7.1.0 and higher
         */
        ReportDropDown.createInMasterDetailRegionUnderWidget = function (container) {
            internal.createInVersionCheck(container.model, ReportDropDown.structureTypeName, { start: "7.1.0" });
            return internal.instancehelpers.createElement(container, ReportDropDown, "widget", false);
        };
        /**
         * Creates and returns a new ReportDropDown instance in the SDK and on the server.
     ...
     * In version 6.10.0: deleted
     */
    var ReportPane = /** @class */ (function (_super) {
        __extends(ReportPane, _super);
        function ReportPane(model, structureTypeName, id, isPartial, unit, container) {
            var _this = _super.call(this, model, structureTypeName, id, isPartial, unit, container) || this;
            /** @internal */
    ...
    var ReportZoomInfo = /** @class */ (function (_super) {
        __extends(ReportZoomInfo, _super);
        function ReportZoomInfo(model, structureTypeName, id, isPartial, unit, container) {
            var _this = _super.call(this, model, structureTypeName, id, isPartial, unit, container) || this;
            /** @internal */
    ...
    var ReportZoomMapping = /** @class */ (function (_super) {
        __extends(ReportZoomMapping, _super);
        function ReportZoomMapping(model, structureTypeName, id, isPartial, unit, container) {
            var _this = _super.call(this, model, structureTypeName, id, isPartial, unit, container) || this;
            /** @internal */
