...
(function (jsonstructures) {
     ...
     */
    var JsonElement = /** @class */ (function (_super) {
        __extends(JsonElement, _super);
        function JsonElement(model, structureTypeName, id, isPartial, unit, container) {
     ...
     */
    var JsonStructure = /** @class */ (function (_super) {
        __extends(JsonStructure, _super);
        function JsonStructure(model, structureTypeName, id, isPartial, container) {
