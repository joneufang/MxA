...
(function (texts) {
     ...
     */
    var SystemText = /** @class */ (function (_super) {
        __extends(SystemText, _super);
        function SystemText(model, structureTypeName, id, isPartial, unit, container) {
     ...
     */
    var SystemTextCollection = /** @class */ (function (_super) {
        __extends(SystemTextCollection, _super);
        function SystemTextCollection(model, structureTypeName, id, isPartial, container) {
    ...
    var Text = /** @class */ (function (_super) {
        ...
        function Text(model, structureTypeName, id, isPartial, unit, container) {
            var _this = _super.call(this, model, structureTypeName, id, isPartial, unit, container) || this;
            /** @internal */
        ...
        Object.defineProperty(Text.prototype, "containerAsCallNanoflowClientAction", {
            get: function () { return _super.prototype.getContainerAs.call(this, pages_1.pages.CallNanoflowClientAction); },
            enumerable: true,
            configurable: true
        });
        ...
        Object.defineProperty(Text.prototype, "containerAsDropDown", {
            get: function () { return _super.prototype.getContainerAs.call(this, pages_1.pages.DropDown); },
            enumerable: true,
            configurable: true
        });
        ...
        Object.defineProperty(Text.prototype, "containerAsLoginTextBox", {
            get: function () { return _super.prototype.getContainerAs.call(this, pages_1.pages.LoginTextBox); },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(Text.prototype, "containerAsMasterDetailDetailRegion", {
            get: function () { return _super.prototype.getContainerAs.call(this, pages_1.pages.MasterDetailDetailRegion); },
            enumerable: true,
            configurable: true
        });
        ...
        Object.defineProperty(Text.prototype, "containerAsWidgetValidation", {
         ...
         *  7.8.0 and higher
         */
        Text.createInCallNanoflowClientActionUnderProgressMessage = function (container) {
         ...
         *  7.2.0 and higher
         */
        Text.createInDropDownUnderEmptyOptionCaption = function (container) {
         ...
         *  7.0.2 and higher
         */
        Text.createInLoginTextBoxUnderLabel = function (container) {
         ...
         *  7.0.2 and higher
         */
        Text.createInLoginTextBoxUnderPlaceholder = function (container) {
            internal.createInVersionCheck(container.model, Text.structureTypeName, { start: "7.0.2" });
            return internal.instancehelpers.createElement(container, Text, "placeholder", false);
        };
        /**
         ...
         *  7.1.0 and higher
         */
        Text.createInMasterDetailDetailRegionUnderTitle = function (container) {
            internal.createInVersionCheck(container.model, Text.structureTypeName, { start: "7.1.0" });
         ...
         *  7.2.0 and higher
         */
        Text.createInReferenceSelectorUnderEmptyOptionCaption = function (container) {
            internal.createInVersionCheck(container.model, Text.structureTypeName, { start: "7.2.0" });
            return internal.instancehelpers.createElement(container, Text, "emptyOptionCaption", false);
        };
        /**
         ...
         *  7.6.0 and higher
         */
        Text.createInWidgetValidationUnderMessage = function (container) {
    ...
    var Translation = /** @class */ (function (_super) {
        ...
        function Translation(model, structureTypeName, id, isPartial, unit, container) {
            var _this = _super.call(this, model, structureTypeName, id, isPartial, unit, container) || this;
            /** @internal */
