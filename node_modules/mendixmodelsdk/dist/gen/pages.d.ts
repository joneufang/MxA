...
export declare namespace pages {
    ...
    abstract class Widget extends internal.Element {
        ...
        readonly containerAsNestedWidgetValue: pluginwidgets.NestedWidgetValue;
        readonly containerAsPluginWidget: pluginwidgets.PluginWidget;
        readonly containerAsTemplatedWidgetValue: pluginwidgets.TemplatedWidgetValue;
    ...
    abstract class ClientAction extends internal.Element {
        ...
        readonly containerAsActionValue: pluginwidgets.ActionValue;
        constructor(model: internal.AbstractModel, structureTypeName: string, id: string, isPartial: boolean, unit: internal.ModelUnit, container: internal.AbstractElement);
    }
    /**
    ...
    class CallNanoflowClientAction extends ClientAction {
         ...
         *  7.8.0 and higher
         */
        static createInActionValueUnderValue(container: pluginwidgets.ActionValue): CallNanoflowClientAction;
        /**
         * Creates and returns a new CallNanoflowClientAction instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class CancelChangesClientAction extends ClientAction {
         ...
         *  7.6.0 and higher
         */
        static createInActionValueUnderValue(container: pluginwidgets.ActionValue): CancelChangesClientAction;
        /**
         * Creates and returns a new CancelChangesClientAction instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class ClientTemplate extends internal.Element {
        ...
        readonly containerAsGroupBox: GroupBox;
        readonly containerAsDynamicTextValue: pluginwidgets.DynamicTextValue;
        template: texts.Text;
         ...
         *  7.1.0 and higher
         */
        static createInDynamicTextValueUnderValue(container: pluginwidgets.DynamicTextValue): ClientTemplate;
        /**
         * Creates and returns a new ClientTemplate instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class ClosePageClientAction extends ClientAction {
         ...
         *  7.6.0 and higher
         */
        static createInActionValueUnderValue(container: pluginwidgets.ActionValue): ClosePageClientAction;
        /**
         * Creates and returns a new ClosePageClientAction instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class MicroflowClientAction extends ClientAction {
         ...
         *  7.6.0 and higher
         */
        static createInActionValueUnderValue(container: pluginwidgets.ActionValue): MicroflowClientAction;
        /**
         * Creates and returns a new MicroflowClientAction instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class NoClientAction extends ClientAction {
         ...
         *  7.6.0 and higher
         */
        static createInActionValueUnderValue(container: pluginwidgets.ActionValue): NoClientAction;
        /**
         * Creates and returns a new NoClientAction instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class OpenLinkClientAction extends ClientAction {
         ...
         *  7.6.0 and higher
         */
        static createInActionValueUnderValue(container: pluginwidgets.ActionValue): OpenLinkClientAction;
        /**
         * Creates and returns a new OpenLinkClientAction instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class PageClientAction extends ClientAction {
         ...
         *  7.6.0 and higher
         */
        static createInActionValueUnderValue(container: pluginwidgets.ActionValue): PageClientAction;
        /**
         * Creates and returns a new PageClientAction instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class SaveChangesClientAction extends ClientAction {
         ...
         *  7.6.0 and higher
         */
        static createInActionValueUnderValue(container: pluginwidgets.ActionValue): SaveChangesClientAction;
        /**
         * Creates and returns a new SaveChangesClientAction instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class SignOutClientAction extends ClientAction {
         ...
         *  7.6.0 and higher
         */
        static createInActionValueUnderValue(container: pluginwidgets.ActionValue): SignOutClientAction;
        /**
         * Creates and returns a new SignOutClientAction instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class SyncClientAction extends ClientAction {
         ...
         *  7.6.0 and higher
         */
        static createInActionValueUnderValue(container: pluginwidgets.ActionValue): SyncClientAction;
        /**
         * Creates and returns a new SyncClientAction instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
    ...
    class WidgetValidation extends internal.Element {
        ...
        readonly containerAsAttributeWidget: AttributeWidget;
        readonly containerAsReferenceSelector: ReferenceSelector;
        readonly containerAsAttributeValue: pluginwidgets.AttributeValue;
        /**
         * The value of this property is conceptually of type microflowExpressions.MicroflowExpression.
         */
        expression: string;
         ...
         *  7.7.0 and higher
         */
        static createInAttributeValueUnderValidations(container: pluginwidgets.AttributeValue): WidgetValidation;
        /**
         * Creates and returns a new WidgetValidation instance in the SDK and on the server.
         * Expects one argument: the IModel object the instance will "live on".
         * After creation, assign or add this instance to a property that accepts this kind of objects.
