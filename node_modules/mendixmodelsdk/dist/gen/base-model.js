...
var BaseModel = /** @class */ (function (_super) {
    ...
    BaseModel.prototype.allBuildingBlocks = function () {
    ...
    BaseModel.prototype.allDocuments = function () {
        return _super.prototype._allOfTypes.call(this, [
            "AppServices$ConsumedAppService", "Constants$Constant", "DataSets$DataSet", "DocumentTemplates$DocumentTemplate", "Enumerations$Enumeration", "ExportMappings$ExportMapping", "Images$ImageCollection", "ImportMappings$ImportMapping", "JavaActions$JavaAction", "JsonStructures$JsonStructure", "Menus$MenuDocument", "MessageDefinitions$MessageDefinitionCollection", "Microflows$Microflow", "Microflows$Nanoflow", "Microflows$Rule", "Pages$BuildingBlock", "Pages$Layout", "Pages$Page", "Pages$PageTemplate", "Pages$Snippet", "RegularExpressions$RegularExpression", "Rest$PublishedODataService", "Rest$PublishedRestService", "ScheduledEvents$ScheduledEvent", "WebServices$ImportedWebService", "WebServices$PublishedAppService", "WebServices$PublishedWebService", "XmlSchemas$XmlSchema"
        ]);
    };
    ...
    BaseModel.prototype.allFormBases = function () {
        return _super.prototype._allOfTypes.call(this, [
            "Pages$BuildingBlock", "Pages$Layout", "Pages$Page", "Pages$PageTemplate", "Pages$Snippet"
        ]);
    };
    ...
    BaseModel.prototype.allMessageDefinitionCollections = function () {
        return _super.prototype._allOfTypes.call(this, [
    ...
    BaseModel.prototype.allModuleDocuments = function () {
        return _super.prototype._allOfTypes.call(this, [
            "AppServices$ConsumedAppService", "Constants$Constant", "DataSets$DataSet", "DocumentTemplates$DocumentTemplate", "DomainModels$DomainModel", "Enumerations$Enumeration", "ExportMappings$ExportMapping", "Images$ImageCollection", "ImportMappings$ImportMapping", "JavaActions$JavaAction", "JsonStructures$JsonStructure", "Menus$MenuDocument", "MessageDefinitions$MessageDefinitionCollection", "Microflows$Microflow", "Microflows$Nanoflow", "Microflows$Rule", "Pages$BuildingBlock", "Pages$Layout", "Pages$Page", "Pages$PageTemplate", "Pages$Snippet", "RegularExpressions$RegularExpression", "Rest$PublishedODataService", "Rest$PublishedRestService", "ScheduledEvents$ScheduledEvent", "WebServices$ImportedWebService", "WebServices$PublishedAppService", "WebServices$PublishedWebService", "XmlSchemas$XmlSchema"
        ]);
    };
    ...
    BaseModel.prototype.allNanoflows = function () {
        return _super.prototype._allOfTypes.call(this, [
            "Microflows$Nanoflow"
        ]);
    };
    ...
    BaseModel.prototype.allPageTemplates = function () {
        return _super.prototype._allOfTypes.call(this, [
            "Pages$PageTemplate"
        ]);
    };
    ...
    BaseModel.prototype.allServerSideMicroflows = function () {
        return _super.prototype._allOfTypes.call(this, [
    ...
    BaseModel.prototype.allTemplateFormBases = function () {
        return _super.prototype._allOfTypes.call(this, [
    ...
    BaseModel.prototype.findEnumerationValueByQualifiedName = function (qname) {
    ...
    BaseModel.prototype.findMessageDefinitionByQualifiedName = function (qname) {
    ...
    BaseModel.prototype.findNanoflowByQualifiedName = function (qname) {
    ...
    BaseModel.prototype.findNavigationProfileByQualifiedName = function (qname) {
