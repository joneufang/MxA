...
let project = new MxA.MxAToTextFile(username, apikey, projectId, "./Test.txt");
...
project.getDocumentsFromProject([qrycons.ID,qrycons.NAME, qrycons.TYPE, qrycons.CONTAINER],[new MxA.Filter(qrycons.NAME, "Testapp")], [qrycons.TYPE,qrycons.NAME]);  //filtered Result with sorting
