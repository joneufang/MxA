...
project.getDocumentsFromProject([QueryConstants_1.documents.propertys.ALL], [], [], [1]); //All Propertys unfiltered
//project.getDocumentsFromProject([qrycons.propertys.ID,qrycons.propertys.NAME, qrycons.propertys.TYPE, qrycons.propertys.CONTAINER, qrycons.propertys.DOCUMENTATION], [], [], [1]);  //unfiltered Result
